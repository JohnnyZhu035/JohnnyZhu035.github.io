...
/* Bezier curve function generator. Copyright Gaetan Renaudeau. MIT License: http://en.wikipedia.org/wiki/MIT_License */function b(e,r,a,o){var i=4,n=1e-7,s=10,l=11,u=1/(l-1),c="Float32Array"in t;
/* Must contain four arguments. */if(4!==arguments.length)return!1;
/* Arguments must be numbers. */for(var p=0;p<4;++p)if("number"!=typeof arguments[p]||isNaN(arguments[p])||!isFinite(arguments[p]))return!1;
/* X values must be in the [0, 1] range. */e=Math.min(e,1),a=Math.min(a,1),e=Math.max(e,0),a=Math.max(a,0);var f=c?new Float32Array(l):new Array(l);function d(e,t){return 1-3*t+3*e}function g(e,t){return 3*t-6*e}function y(e){return 3*e}function m(e,t,r){return((d(t,r)*e+g(t,r))*e+y(t))*e}function h(e,t,r){return 3*d(t,r)*e*e+2*g(t,r)*e+y(t)}function v(t){for(var r=0,o=1,c=l-1;o!=c&&f[o]<=t;++o)r+=u;--o;var p=r+(t-f[o])/(f[o+1]-f[o])*u,d=h(p,e,a);return d>=.001?function(t,r){for(var o=0;o<i;++o){var n=h(r,e,a);if(0===n)return r;r-=(m(r,e,a)-t)/n}return r}(t,p):0==d?p:function(t,r,o){var i,l,u=0;do{(i=m(l=r+(o-r)/2,e,a)-t)>0?o=l:r=l}while(Math.abs(i)>n&&++u<s);return l}(t,r,r+u)}var b=!1;function x(){b=!0,e==r&&a==o||function(){for(var t=0;t<l;++t)f[t]=m(t*u,e,a)}()}var S=function(t){return b||x(),e===r&&a===o?t:0===t?0:1===t?1:m(v(t),r,o)};S.getControlPoints=function(){return[{x:e,y:r},{x:a,y:o}]};var P="generateBezier("+[e,r,a,o]+")";return S.toString=function(){return P},S}
